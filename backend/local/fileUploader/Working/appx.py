...
def get_message():
    ...
    x = pd.read_csv('/Users/anishpawar/dev/SIH/Repo/Hack_Inversion-SIH/backend/local/fileUploader/Working/nymex_4ind.csv')
    xnew1 = x['Date']
    xnew2 = x['Close']
    date = xnew1.values.tolist()
    closex = xnew2.values.tolist()

# k = xnew.values.tolist()
    # values = [12, 19, 3, 5, 2, 3]
    # labels = ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange']
    # colors = ['#ff0000','#0000ff','#ffffe0','#008000','#800080','#FFA500']


    return render_template("please.html",dates=date, closex=closex)
